...
$xml->makewebpivot(\@array, '', \@fields, 'Count', $filename, 'Test
Pivot');
###############################################################################
...
ok(-f $filename . '_files/' . $filename . '_4267_cachedata001.xml', 
'listing file created');
### now clean up the files we created
unlink $filename . '.htm';
unlink $filename . '_files/filelist.xml';
unlink $filename . '_files/' . $filename . '_4267_cachedata001.xml';
